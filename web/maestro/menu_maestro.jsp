...
<nav class="navbar navbar-expand-lg navbar-formal">
    <div class="container-fluid">
        <a class="navbar-brand" href="<%= rutaBase %>/maestro/SPanel"><i class="bi bi-mortarboard me-2"></i>Control Escolar</a>
        ...
        <div class="collapse navbar-collapse" id="menuMaestro">
            <div class="navbar-nav flex-wrap">
                <a class="nav-link <%= uriActual.contains("SPanel") ? "active" : ""%>" href="<%= rutaBase %>/maestro/SPanel">Panel</a>
                <a class="nav-link <%= uriActual.contains("SCalificaciones") ? "active" : ""%>" href="<%= rutaBase %>/maestro/SCalificaciones">Mis grupos y calificaciones</a>
                <a class="nav-link" href="<%= rutaBase %>/SLogout"><i class="bi bi-box-arrow-right me-1"></i>Salir</a>
            </div>
        </div>
