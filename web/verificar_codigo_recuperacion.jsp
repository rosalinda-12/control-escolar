    ...
    <body>
        <div class="contenedor-centrado">
            <div class="card card-formal">
                <div class="card-header"><i class="bi bi-envelope-check me-2"></i>Verifica tu código</div>
                <div class="card-body">
                    <p class="texto-info">Te enviamos un código de 6 dígitos a tu correo. Vence a los 2 minutos de haberlo pedido.</p>
                    ...
                    <form method="post" action="SVerificarCodigoRecuperacion" class="mt-3">
                    ...
                    <form method="post" action="SVerificarCodigoRecuperacion" class="mt-2">
                        <input type="hidden" name="idUsuario" value="<%= idUsuario%>">
